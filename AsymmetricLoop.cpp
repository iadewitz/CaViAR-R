...
// [[Rcpp::export]]
NumericVector CAViaR_Asymmetric(NumericVector beta, NumericVector data, double empiricalQuantile)
{
  int i;
...
// [[Rcpp::export]]
NumericVector predict_CAViaR_Asymmetric(NumericVector beta, NumericVector data, double lastquantile, int h)
{
  int i;
  int data_length = data.length();
